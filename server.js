...
app.get('/sitemap.xml', (_req, res) => {
  const urls = [
    ...
    { loc: '/blog/ia-para-abogados-guia-practica', priority: '0.9', changefreq: 'monthly' },
    { loc: '/blog/chatgpt-vs-claude-para-abogados', priority: '0.9', changefreq: 'monthly' },
    { loc: '/blog/datos-clientes-ia-rgpd-secreto-profesional-abogados', priority: '0.9', changefreq: 'monthly' },
    { loc: '/blog/prompts-juridicos-para-abogados', priority: '0.9', changefreq: 'monthly' },
    { loc: '/blog/alucinaciones-ia-jurisprudencia-inventada-abogados', priority: '0.9', changefreq: 'monthly' },
    { loc: '/blog/reglamento-europeo-ia-abogados-ai-act', priority: '0.9', changefreq: 'monthly' },
    { loc: '/blog/cuanto-cuesta-ia-para-despacho-abogados', priority: '0.9', changefreq: 'monthly' },
    { loc: '/blog/claude-para-abogados-como-usarlo-en-tu-despacho', priority: '0.8', changefreq: 'monthly' },
    { loc: '/blog/redactar-demanda-despido-con-ia-caso-practico', priority: '0.8', changefreq: 'monthly' },
    { loc: '/blog/marketing-juridico-con-ia-captar-clientes-despacho', priority: '0.8', changefreq: 'monthly' },
    ...
    { loc: '/blog/como-redactar-escritos-judiciales-con-ia', priority: '0.9', changefreq: 'monthly' },
    { loc: '/blog/ia-para-procuradores-y-personal-de-despacho', priority: '0.9', changefreq: 'monthly' },
